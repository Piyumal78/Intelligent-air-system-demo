...
const AdminDevices = () => {
  const { devices, users, registerDevice, deleteDevice, updateDeviceStatus } = useSystem()
  ...
  const getAssignedUserName = (assignedUserId) => {
    ...
    const user = users.find(u => u.id === assignedUserId || u.uid === assignedUserId)
    return user ? user.username || user.email : assignedUserId
  }
          ...
          >
            ...
            <div className="flex flex-col gap-2 text-sm pt-4 border-t border-slate-50">
              <div className="flex justify-between text-slate-500">
                ...
                <span className="font-medium text-slate-700">{getAssignedUserName(device.assignedUser)}</span>
              </div>
              <div className="flex justify-between text-slate-500">
                <span>Last Sync:</span>
